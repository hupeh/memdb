...
func TestBTree_Put_Get(t *testing.T) {
	mt := newBTree(nil)
...
func TestBTree_Ascend_Descend(t *testing.T) {
	mt := newBTree(nil)
	w, _ := wal.Open(wal.DefaultOptions)
...
func TestBTree_AscendRange_DescendRange(t *testing.T) {
	mt := newBTree(nil)
	w, _ := wal.Open(wal.DefaultOptions)
...
func TestBTree_AscendGreaterOrEqual_DescendLessOrEqual(t *testing.T) {
	mt := newBTree(nil)
	w, _ := wal.Open(wal.DefaultOptions)
